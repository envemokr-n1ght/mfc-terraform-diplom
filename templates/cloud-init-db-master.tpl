...
runcmd:
  ...
  # ----- 2. Добавление репозитория PostgreSQL 17 -----
  ...
  # ----- 4. Создание пользователя и БД для веб-приложения -----
  ...
  # ----- 7. Настройка синхронной репликации -----
  ...
  # ----- 11. Настройка zabbix_agent2.conf -----
  ...
  # ----- 12. Настройка плагина PostgreSQ -----
  ...
  # ----- 13. Запуск агента и перезапуск PostgreSQL -----
